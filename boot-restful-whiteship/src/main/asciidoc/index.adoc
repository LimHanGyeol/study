...
| `400 Bad Request`
| 잘못된 요청을 보낸 경우, 응답 본문에 오류에 대한 상세 정보가 담겨있다
...
예를 들어, 잘못된 요청으로 이벤트를 만드려고 했을 때 다음과 같은 `400 Bad Request` 응답을 받는다.
...
operation::index[snippets='resonse-body,http-response,links']
